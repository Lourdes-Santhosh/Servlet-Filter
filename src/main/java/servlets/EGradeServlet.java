...
@WebServlet("/EGrade")
public class EGradeServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.getWriter().println("<title>EGrade</title>");
        ...
        response.getWriter().println("<h1>You got E Grade. Must do hardwork.</h1>");
