...
@WebServlet("/DGrade")
public class DGradeServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.getWriter().println("<title>DGrade</title>");
        ...
        response.getWriter().println("<h1>You got D Grade. Concentrate on Studies</h1>");
