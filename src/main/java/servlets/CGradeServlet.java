...
@WebServlet("/CGrade")
public class CGradeServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.getWriter().println("<title>CGrade</title>");
        ...
        response.getWriter().println("<h1>You got C Grade. Try Harder next time :)</h1>");
