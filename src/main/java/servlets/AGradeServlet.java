...
@WebServlet("/AGrade")
public class AGradeServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.getWriter().println("<title>AGrade</title>");
        ...
        response.getWriter().println("<h1>Congratulations! You got A Grade.</h1>");
